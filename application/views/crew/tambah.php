...
<div class="container-fluid">
    ...
    <div class="rounded mt-4 mb-5 p-4 bg-white shadow-lg ">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control <?= form_error('nama') ? 'is-invalid' : null; ?>" id="nama" name="nama">
            <?= form_error('nama'); ?>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control <?= form_error('alamat') ? 'is-invalid' : null; ?>" id="alamat" name="alamat">
            <?= form_error('alamat'); ?>
        </div>
